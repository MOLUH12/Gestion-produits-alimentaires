...
<html>
    <head>
        ...
        <title>Project JEE  gestion d’un cabinet médical </title>
        <link rel="stylesheet"
    ...
    <body>
        <nav class="navbar navbar-expand-md navbar-light bg-light">
            <a href="index.jsp" class="navbar-brand"> <img src="img/iai.png"
                                                   height="50" width="50" alt="cabinet medical ">
            </a>
        ...
        <div>
            <h1>
                <b>Project JEE  gestion cabinet medical: cas de DERMA </b>
            </h1>
        </div>
